...
1. Скачали terraform. Настроили зависимости в операционной системе.
2. Настроили сервисную учетную запись terraform-service в yandex cloud.
3. Определили ресурсы для развертывание HTTP балансировщика через terraform в lb.tf.
4. Описали провайдера и provisioner для подключения и развертывания приложения в main.tf
5. Описали конфигурацию через переменные variables и значения в terraform.tvars.example.
